...
# Wine download links from WineHQ: https://dl.winehq.org/wine-builds/
# Note: using http instead of https to make use of cache
...
wget 'http://ftp.us.debian.org/debian/pool/main/f/faudio/libfaudio0_21.02-1~bpo10+1_i386.deb' # Using fixed version to make use of cache
